...
// export const DB_DATABASE = process.env.MYSQL_DATABASE || "todo_tutorial";
// export const DB_PORT = process.env.MYSQL_PORT || "3306";

// export const DB_HOST = "roundhouse.proxy.rlwy.net";
// export const DB_USER = "root";
// export const DB_PASSWORD = "MWnPDhYDtmMWZHTNDaBZQhEfZewYjwul";
// export const DB_DATABASE = "railway";
// export const DB_PORT = "54130";